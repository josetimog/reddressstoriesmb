...
//   const [isFocused, setIsFocused] = useState(false);
//   const navigate = useNavigate();
//   const { i18n } = useTranslation(); // i18n hook
...
//                 ml: 2,
//                 fontFamily: "Lato, sans-serif",
//                 "& .MuiSelect-icon": { color: "#f3ece4" },
//               }}
//             >
//               <MenuItem value="en">English</MenuItem>
//               <MenuItem value="fr">Français</MenuItem>
//               <MenuItem value="oj">Ojibwe</MenuItem>
...
//             {/* Language Selector in Drawer (Optional) */}
...
const Header = () => {
  ...
  return (
    <AppBar position="sticky" sx={{ backgroundColor: "#a8281f", zIndex: 1000 }}>
      <Toolbar sx={{ display: "flex", alignItems: "center", px: 2 }}>
        {/* Logo */}
        <Link
          component={RouterLink}
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                ...
                sx={{ px: 2, py: 0.5, fontFamily: "Lato, sans-serif" }}
              />
            )}
          />
        </Box>
            ...
            {navItems.map((item) => (
              <ListItem key={item.key} disablePadding>
                <ListItemButton component={RouterLink} to={item.href}>
                  <ListItemText
                    primary={t(item.key)}
                    primaryTypographyProps={{ fontFamily: "Lato, sans-serif" }}
                  />
                </ListItemButton>
              </ListItem>
            ))}
            ...
            <ListItem disablePadding>
              <ListItemButton>
                <Select
                  ...
                  onChange={(e) => i18n.changeLanguage(e.target.value)}
                  disableUnderline
                  sx={{ fontFamily: "Lato, sans-serif", mx: 2 }}
                >
                  <MenuItem value="en">English</MenuItem>
                  <MenuItem value="fr">Français</MenuItem>
                  <MenuItem value="oj">Ojibwe</MenuItem>
