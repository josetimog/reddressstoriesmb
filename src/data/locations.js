...
const zeroDist = 59959.436;

function getLocations() {
  const screenHeight = window.innerHeight;

  const calcZoom = (distance) =>
    Math.log2((0.55 * screenHeight * zeroDist) / distance);

  return {
    manitoba: {
      center: [-97.01, 55.5],
      zoom: calcZoom(1225000),
    },
    thePas: {
      center: [-101.245502, 53.821273],
      zoom: calcZoom(225000),
    },
    winnipeg: {
      center: [-97.138726, 49.904772],
      zoom: calcZoom(25000),
    ...
    lbCsTn: {
      center: [-97.16642716938573, 49.901892091430135],
      zoom: calcZoom(2200),
    },
    guyHill: {
      center: [-101.03662326087897, 53.98511198884964],
    },
    gordonBell: {
      center: [-97.16207083120011, 49.88638664359836],
    },
    margaretBarbour: {
      center: [-101.24143643340821, 53.82484338795254],
    },
    thirdStreet: {
      center: [-101.24908131023437, 53.82484615085207],
      zoom: calcZoom(25000),
    ...
    pumpHouse: {
      center: [-101.08409267931427, 53.984216803908254],
    },
    albertaWpg: {
      center: [-95.025504, 59.099538],
      zoom: calcZoom(1800000),
    },
    prairies: {
      center: [-105.9394691534559, 55.5],
      zoom: calcZoom(1225000 * 2),
    },
    fisherRiver: {
      center: [-97.38607310272987, 51.43772267169117],
      zoom: calcZoom(2000),
    ...
    canada: {
      center: [-100.01, 59],
      zoom: calcZoom(5000000),
    },
  };
}

export { getLocations, zeroDist };
